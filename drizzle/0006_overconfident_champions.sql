ALTER TABLE "patient_billing_profiles" ALTER COLUMN "preferred_payment_method" SET DATA TYPE text;--> statement-breakpoint
DROP TYPE "public"."patient_payment_method";--> statement-breakpoint
CREATE TYPE "public"."patient_payment_method" AS ENUM('insurance', 'self_pay', 'payment_plan', 'credit_card', 'cash', 'check');--> statement-breakpoint
ALTER TABLE "patient_billing_profiles" ALTER COLUMN "preferred_payment_method" SET DATA TYPE "public"."patient_payment_method" USING "preferred_payment_method"::"public"."patient_payment_method";--> statement-breakpoint
ALTER TABLE "patient_billing_profiles" DROP COLUMN "guarantor_name";--> statement-breakpoint
ALTER TABLE "patient_billing_profiles" DROP COLUMN "guarantor_phone";--> statement-breakpoint
ALTER TABLE "patient_billing_profiles" DROP COLUMN "guarantor_relationship";--> statement-breakpoint
ALTER TABLE "patient_billing_profiles" DROP COLUMN "notes";--> statement-breakpoint
...
ALTER POLICY "lab_tests_select_policy" ON "lab_tests" TO public USING (
      ...
      EXISTS (
        ...
        WHERE orgLab.id = "lab_tests"."lab_id"
          AND orgLab.organization_id = NULLIF(current_setting('lis.active_organization_id', true), '')::uuid
      )
